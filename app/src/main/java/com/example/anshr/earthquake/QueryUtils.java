...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link Earthuakejava} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<Earthuakejava> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<Earthuakejava> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for(int i=0;i<earthquakeArray.length();i++)
            {
                ...
                Earthuakejava earthquake=new Earthuakejava(magnitude,location,time);
